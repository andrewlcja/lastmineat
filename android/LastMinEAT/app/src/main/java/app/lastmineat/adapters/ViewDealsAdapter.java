...
public class ViewDealsAdapter extends RecyclerView.Adapter<ViewDealsAdapter.ViewHolder> {
    private final Context context;
    private final List<Deal> dealList;
    private static ClickListener clickListener;

    public ViewDealsAdapter(Context context, List<Deal> dealList) {
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        ViewDealsAdapter.clickListener = clickListener;
    }
